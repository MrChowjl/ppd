...
export async function audited(params: any) {
    return request('/v1/manage/audited/ad_design', {
        method: 'POST',
        data: params,
    });
}
...
export async function queryList(params: any) {
    return request('/v1/manage/ad_design_list', {
        method: 'GET',
        params: params,
    });
}
...
export async function deleteCurrent(params: any) {
    return request('/v1/manage/delete/ad_design', {
        method: 'POST',
        data: params,
    });
}
...
export async function switchAccount(params: any) {
    return request('/v1/manage/switch/ad_design', {
        method: 'GET',
        params: params,
    });
}
