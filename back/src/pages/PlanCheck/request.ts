...
export async function queryList(params: any) {
    return request('/v1/manage/ad_plan_list', {
        method: 'GET',
        params: params,
    });
}
...
export async function deleteCurrent(params: any) {
    return request('/v1/manage/delete/ad_plan', {
        method: 'POST',
        data: params,
    });
}
...
export async function makeAudit(params: any) {
    return request('/v1/manage/audited/ad_plan', {
        method: 'POST',
        data: params,
    });
}
...
export async function switchAccount(params: any) {
    return request('/v1/manage/switch/ad_plan', {
        method: 'GET',
        params: params,
    });
}
